...
public class PortraitCameraView extends CameraBridgeViewBase implements Camera.PreviewCallback {
    ...
    protected PortraitCameraView.PortraitCameraFrame[] mCameraFrame;
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (sizes != null) {
                    ...
                    mCameraFrame[0] = new PortraitCameraFrame(mFrameChain[0], mFrameWidth, mFrameHeight);
                    mCameraFrame[1] = new PortraitCameraFrame(mFrameChain[1], mFrameWidth, mFrameHeight);
    ...
    protected boolean connectCamera(int width, int height) {
        ...
        mStopThread = false;
        mThread = new Thread(new PortraitCameraView.CameraWorker());
        mThread.start();
